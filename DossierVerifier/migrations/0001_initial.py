    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loca_sont_dans_les_lieux', models.CharField(default=0, max_length=50, null=True)),
                ('loca_sont_pas_dans_les_lieux', models.CharField(default=0, max_length=50 , null=True)),
                ('oui_incident_dernier_mois', models.CharField(default=0, max_length=50 , null=True)),
                ('non_incident_dernier_mois', models.CharField(default=0, max_length=50 , null=True)),
                ('loca_dans_les_lieux_depuis', models.CharField(default=0, max_length=50 , null=True)),
